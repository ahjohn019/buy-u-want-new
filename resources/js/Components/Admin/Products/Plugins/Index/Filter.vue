<template>
    ...
    >
        ...
        <!-- <n-divider />
        <p>Category</p>
        <n-checkbox-group class="mt-2">
            <n-grid :y-gap="4" :cols="1">
                <n-gi>
                    <n-checkbox value="Addidas" label="Addidas" />
                </n-gi>
                <n-gi>
                    <n-checkbox value="Nike" label="Nike" />
                </n-gi>
                <n-gi>
                    <n-checkbox value="Umbro" label="Umbro" />
                </n-gi>
                <n-gi>
                    <n-checkbox value="Asic" label="Asic" />
                </n-gi>
            </n-grid>
        </n-checkbox-group> -->
    </div>
